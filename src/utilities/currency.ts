...
export const formatCurrency = (
  ...
  return customSymbol
    ? formattedAmount.replaceAll(new RegExp(`[\\p{Sc}]`, 'gu'), customSymbol) // Thay thế tất cả ký hiệu tiền tệ mặc định
    : formattedAmount;
};
/**
 * Định dạng tiền tệ với mã tiền tệ làm đuôi hiển thị đơn vị.
...
export const formatCurrencyWithCodeAsSuffix = (
  ...
  if (isNaN(parsedAmount)) {
    throw new TypeError('Invalid amount. Please provide a valid number.');
  }
