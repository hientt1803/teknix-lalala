...
// AccordionHeader
export function AccordionHeader({ children, icon }: { children: ReactNode; icon?: ReactNode }) {
   ...
   return (
      ...
      >
         ...
         <Button size="icon" variant={isActive ? 'default' : 'ghost'} className={cn('rounded-lg')}>
            {icon ? (
               <motion.div
