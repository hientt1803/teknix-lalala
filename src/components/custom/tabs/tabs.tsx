      ...
      <div>
         ...
         <div className="hidden sm:block">
            <div className="border-b border-neutral-200">
               <nav className="-mb-px flex gap-6 transition-colors duration-200" aria-label="Tabs">
                  {tabs.map((tab) => (
                     <a
                        key={tab.value}
                        href="#"
                        ...
                        className={`inline-flex shrink-0 items-center gap-2 border-b-2 px-1 pb-4 text-sm font-medium ${
                           value === tab.value
                              ...
                              : 'border-transparent text-neutral-500 dark:text-neutral-300 hover:border-neutral-300 hover:text-neutral-700'
                        }`}
