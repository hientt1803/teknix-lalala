    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <div className="relative flex h-12 w-12 items-center justify-center">
          <Button
            variant="ghost"
            className="flex h-10 w-10 items-center justify-center rounded-full text-neutral-700 hover:bg-neutral-100 focus:outline-none dark:text-neutral-300 dark:hover:bg-neutral-800 lg:h-12 lg:w-12"
            size={'icon'}
          >
            <Avatar>
              <AvatarImage
      ...
      >
        ...
        <div className="relative grid gap-6 p-5">
          ...
          <Button
            ...
            variant={'ghost'}
            className="-m-3 flex items-center justify-start rounded-lg p-2 transition duration-150 ease-in-out hover:bg-gray-50 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50 dark:hover:bg-gray-700"
          >
            <div className="flex flex-shrink-0 items-center justify-center text-neutral-500 dark:text-neutral-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
