...
const Footer = async () => {
    ...
    return <div className="bg-black text-white mt-8">
        <Bounded as='footer' className="divide-y divide-neutral-700">
