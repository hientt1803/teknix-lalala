...
const TourSection = ({ slice }: TourSectionProps): JSX.Element => {
   return (
      ...
      >
         <div className="absolute inset-y-0 w-screen xl:max-w-[1340px] 2xl:max-w-screen-2xl left-1/2 transform -translate-x-1/2 xl:rounded-[40px] z-0 bg-slate-100 dark:bg-slate-800 dark:bg-opacity-20 " />

         <div className="relative">
            <div className="flex flex-col mb-8 relative">
               {/* HEADING */}
               <div className="nc-Section-Heading relative flex flex-col sm:flex-row sm:items-end justify-between mb-10 md:mb-12 text-slate-900 dark:text-neutral-50">
