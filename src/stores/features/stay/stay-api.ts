...
export const StayAPI = createApi({
   ...
   endpoints: (build) => ({
      ...
      >({
         ...
         transformResponse: (response: { data: ISearchLocationByKeyWordResponse }) => response.data,
      }),
      ...
      >({
         ...
         transformResponse: (response: { data: IHotelSearchRegionResult }) => response.data,
      }),
      ...
      getStaylDataById: build.query<IHotelReservation, { id: string }>({
         ...
         transformResponse: (response: { data: IHotelReservation }) => response.data,
      }),
