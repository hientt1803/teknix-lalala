...
const FlightFeatures = ({ primary }: FlightFeaturesType) => {
   ...
   return (
      <div className="min-w-full min-h-screen relative space-y-8">
         <div className="h-screen w-full relative flex flex-col justify-center items-center">
            ...
            <Bounded className="flex flex-col justify-center items-center gap-16 z-30 mt-16">
               <div className="relative w-full flex flex-col items-center justify-center gap-3">
                  ...
                  <h1 className="font-bold text-6xl text-white text-center z-10">
                     Let&apos;s Discover <br /> London
                  </h1>
                  <span className="absolute -bottom-2 z-0 hidden md:block mt-4">
                     <svg width="300px" height="21.5px" viewBox="0 0 445.5 21.5" fill="#4137a1">
