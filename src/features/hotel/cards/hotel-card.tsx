   ...
   return (
      <Card className="group relative border-neutral-200 dark:border-neutral-700 overflow-hidden hover:shadow-xl rounded-[1.875rem] transition-shadow w-full h-full">
         <div className={cn('h-full w-full grid grid-cols-5 items-center')}>
            ...
            <div
               className={cn(
                  'w-full h-full flex flex-col items-start justify-between bg-white dark:bg-neutral-900 dark:text-neutral-200 z-20 rounded-[1.875rem]',
                  displayType == 'list'
               ...
               <div className="w-full flex justify-between items-center flex-wrap p-5 lg:p-0 lg:px-3">
                  ...
                  <Link href={directLink}>
                     <Button
                        variant="default"
                        className={cn(
                           'text-sm transition-all duration-300 ease-in-out rounded-full mt-2 sm:mt-0 font-medium bg-neutral-100 dark:bg-neutral-200 text-black dark:text-neutral-800 hover:bg-neutral-800 dark:hover:bg-neutral-700 hover:text-neutral-200 dark:hover:text-neutral-200',
                        )}
                     >
