...
export const mockAgent: Agent[] = [
   {
      ...
      imageUrl: 'https://travila-nextjs.vercel.app/assets/imgs/page/pages/team6.png',
   ...
   },
   {
      ...
      position: 'Founder and Principal Broker',
      imageUrl: 'https://travila-nextjs.vercel.app/assets/imgs/page/pages/team.png',
      desc: 'With over 15 years of real estate experience, John leads the Travila team with passion and expertise. His commitment to client satisfaction and market knowledge sets the standard for our exceptional service.',
   },
   {
      id: 3,
   ...
   },
   {
      ...
      name: 'Jerome Bell',
      position: 'Founder and Principal Broker',
      imageUrl: 'https://travila-nextjs.vercel.app/assets/imgs/page/pages/team3.png',
      desc: 'With over 15 years of real estate experience, John leads the Travila team with passion and expertise. His commitment to client satisfaction and market knowledge sets the standard for our exceptional service.',
   },
   {
      id: 5,
      name: 'Jenny Wilson',
      position: 'Founder and Principal Broker',
      imageUrl: 'https://travila-nextjs.vercel.app/assets/imgs/page/pages/team4.png',
      desc: 'With over 15 years of real estate experience, John leads the Travila team with passion and expertise. His commitment to client satisfaction and market knowledge sets the standard for our exceptional service.',
   },
   {
      id: 6,
      name: 'Floyd Miles',
      position: 'Founder and Principal Broker',
      imageUrl: 'https://travila-nextjs.vercel.app/assets/imgs/page/pages/team5.png',
      desc: 'With over 15 years of real estate experience, John leads the Travila team with passion and expertise. His commitment to client satisfaction and market knowledge sets the standard for our exceptional service.',
   },
];
