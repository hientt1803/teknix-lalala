            ...
            <div className="flex flex-col md:flex-row">
               ...
               <div className="flex-grow mt-10 md:mt-0 md:pl-16 max-w-3xl space-y-6">
                  ...
                  <div>
                     ...
                     <Select>
                        <SelectTrigger className="w-full border border-neutral-200 dark:border-neutral-700 focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 bg-white dark:bg-neutral-800 rounded-2xl text-sm font-normal h-11 px-4 py-3 mt-1.5">
                        ...
                        <PopoverTrigger asChild>
                           <div>
                              ...
                              <Button
                                 variant={'outline'}
                                 className={cn(
                                    'w-full flex justify-between items-center border border-neutral-200 dark:border-neutral-700 focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 bg-white dark:bg-neutral-800 rounded-2xl text-sm font-normal h-11 px-4 py-3 mt-1.5',
                  ...
                  <div>
                     ...
                     <Textarea
                        ...
                        className="block w-full border border-neutral-200 dark:border-neutral-700 focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 bg-white dark:bg-neutral-800 rounded-2xl text-sm font-normal min-h-[100px] px-4 py-3 mt-1.5"
                        rows={5}
                     />
                  </div>
                  <div className="pt-2">
