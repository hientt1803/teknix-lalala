...
import {
  datas,
  renderIcon,
} from '@/features/checkout/components/credit-card-user';
      ...
      <div className="space-y-6 sm:space-y-8">
        ...
        <div className="max-w-2xl">
          ...
          <span className="block text-neutral-700 dark:text-neutral-400">
            ...
            The time it takes for the funds to appear in your account depends on
            your payout method. Learn more
          </span>
          <div className="pt-10">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col">
                      <h3 className="text-sm font-medium">
                        <span className="capitalize">{data.type}</span> ending
                        in 2026
                      </h3>
                      ...
                      <DialogContent className="max-w-[30rem]">
                        ...
                        <div className="space-y-8">
                          <div className="flex flex-col items-center justify-center gap-2 text-center">
                            <h3 className="px-10 text-2xl font-bold">
