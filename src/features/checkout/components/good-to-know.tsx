...
const GoodToKnow = () => {
  return (
    <div>
      ...
      <span className="mt-3 text-sm text-neutral-400">Good to now</span>
      ...
      <ul className="flex flex-col space-y-4 text-sm text-neutral-600 dark:text-neutral-50">
        <li className="flex items-center gap-2">
          <svg
            className="size-5 stroke-[1.5] text-green-700"
        ...
        <li className="flex items-center gap-2">
          ...
          Stay flexible: You can cancel for free anytime – lock in this great
          price today.
        </li>
        <li className="flex items-center gap-2">
          <svg
