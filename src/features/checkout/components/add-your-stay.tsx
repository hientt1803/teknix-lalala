...
const datas = [
  {
    ...
    icon: (
      <Caravan className="size-10 stroke-[1.3] text-neutral-700 dark:text-neutral-400" />
    ),
    description:
  ...
  },
  {
    ...
    icon: (
      <Plane className="size-10 stroke-[1.3] text-neutral-700 dark:text-neutral-400" />
    ),
    description:
  ...
  },
  {
    ...
    icon: (
      <CarFront className="size-10 stroke-[1.3] text-neutral-700 dark:text-neutral-400" />
    ),
    description:
  ...
  },
  {
    ...
    icon: (
      <IdCard className="size-10 stroke-[1.3] text-neutral-700 dark:text-neutral-400" />
    ),
    description:
        ...
        {datas.map((data, index) => (
          ...
          >
            <div className="flex items-start space-x-3 py-3 lg:w-4/5">
              ...
              <label
                htmlFor={index + ''}
                className="flex flex-col gap-2 text-sm leading-none"
              >
