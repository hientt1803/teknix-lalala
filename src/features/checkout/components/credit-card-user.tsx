...
export const renderIcon = (logo: 'stripe' | 'visa' | 'master', className?: string) => {
   switch (logo) {
      case 'stripe':
         return (
            <svg className={cn(className)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 214">
               <path
                  fill="#635bff"
      ...
      case 'visa':
         return (
            <svg className={cn(className)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 83">
               <defs>
      ...
      case 'master':
         return (
            <svg className={cn(className)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 199">
   ...
   return (
      <div className="py-8 space-y-8">
         <div className="grid grid-cols-1 gap-4">
            <h5 className="text-sm text-neutral-400  ">Choose your card to continune pay</h5>
