...
const PaymentSection = () => {
  return (
    <div className="rounded-2xl border border-neutral-50 shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
      <h1 className="p-5 text-3xl font-bold">💳 Payment Options</h1>
      <div className="w-full border-b border-b-neutral-200" />
      <div className="p-5">
        <div className="flex items-center justify-between rounded-lg bg-indigo-100/80 px-5 py-4">
          <div className="flex items-center justify-center gap-2">
            ...
            <div className="flex flex-col gap-1">
              <h4 className="text-xl font-bold">Get Additional Discount</h4>
      ...
      <div className="p-5">
        ...
        <div className="ml-2 mt-5 text-sm text-neutral-600">
