...
const InfoSection = async ({
  ...
  return (
    <div className="rounded-2xl shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
      <h1 className="p-5 text-3xl font-bold">🏢 Hotel infomation</h1>
      ...
      <div className="grid grid-cols-4 items-center gap-5 p-5">
        <Image
          ...
          className="col-span-1 aspect-[4/3] rounded-2xl"
          alt=""
        />
      ...
      <div className="grid grid-cols-3 gap-5 px-5">
        <div className="flex flex-col justify-between gap-1 rounded-2xl bg-zinc-50 p-5">
          <span className="text-sm">Check-in</span>
          <h3 className="text-xl font-bold">
            {formatDate(checkin_date, 'dd MMM yyyy')}
          </h3>
        ...
        <div className="flex flex-col justify-between gap-1 rounded-2xl bg-zinc-50 p-5">
          ...
          <h3 className="text-xl font-bold">
            {formatDate(checkout_date, 'dd MMM yyyy')}
          </h3>
          <p className="flex items-center gap-1 text-sm text-neutral-600">
            <Clock className="h-4 w-4" />
          ...
          <div className="flex flex-col gap-3 p-5">
            ...
            <ul className="flex flex-col gap-3 text-base text-neutral-600">
              ...
              <li className="flex items-center gap-2">
                ...
                {rateMetaData?.payment_options?.payment_types[0]
