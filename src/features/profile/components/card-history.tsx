...
const CardHistory = ({data}: Props) => {
    ...
    return (
        <div className="grid grid-cols-1 lg:flex lg:flex-row rounded-3xl overflow-hidden border relative border-slate-200 hover:shadow-xl cursor-pointer">
            ...
            <div className="flex-grow p-3 sm:p-5 flex flex-col">
                ...
                <div className="flex justify-between items-end">
                    ...
                    {data.record.status === "pending" && (
                        <Button onClick={() => handleContinunePay(record, hotel)}>
                            Continue pay
                        </Button>
                    )}
                </div>
